...
export function GameScreen() {
  ...
  if (phase === "waiting") {
    return (
      <div className="w-full h-full flex flex-col items-center justify-center gap-6 bg-saigon-dark">
        ...
        <p className="text-white/40 font-pixel text-xs animate-pulse">Waiting for player...</p>
      </div>
    );
  }
